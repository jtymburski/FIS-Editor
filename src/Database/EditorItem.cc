...
EditorItem::EditorItem(QWidget *parent) : QWidget(parent)
{
  ...
  composition_wood = new QCheckBox("Wood",this);
  composition_layout->addWidget(composition_wood);
  composition_steel = new QCheckBox("Steel",this);
  composition_layout->addWidget(composition_steel);
  composition_brass = new QCheckBox("Brass",this);
  composition_layout->addWidget(composition_brass);
  composition_titanium = new QCheckBox("Titanium",this);
  composition_layout->addWidget(composition_titanium);
  composition_graphene = new QCheckBox("Graphene",this);
  composition_layout->addWidget(composition_graphene);
  composition_physical = new QCheckBox("Physical",this);
  composition_layout->addWidget(composition_physical);
  composition_nonphysical = new QCheckBox("Non-Physical",this);
  ...
  itemtier_trash = new QCheckBox("Trash",this);
  itemtier_layout->addWidget(itemtier_trash);
  itemtier_common = new QCheckBox("Common",this);
  itemtier_layout->addWidget(itemtier_common);
  itemtier_uncommon = new QCheckBox("Uncommon",this);
  itemtier_layout->addWidget(itemtier_uncommon);
  itemtier_rare = new QCheckBox("Rare",this);
  itemtier_layout->addWidget(itemtier_rare);
  itemtier_veryrare = new QCheckBox("Very Rare",this);
  itemtier_layout->addWidget(itemtier_veryrare);
  itemtier_legendary = new QCheckBox("Legendary",this);
  itemtier_layout->addWidget(itemtier_legendary);
  itemtier_none = new QCheckBox("None",this);
  ...
  occasion_always = new QCheckBox("Always",this);
  occasion_layout->addWidget(occasion_always);
  occasion_battle = new QCheckBox("Battle",this);
  occasion_layout->addWidget(occasion_battle);
  occasion_menu = new QCheckBox("Menu",this);
  occasion_layout->addWidget(occasion_menu);
  occasion_none = new QCheckBox("None",this);
