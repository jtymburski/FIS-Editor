...
EditorMapThing::EditorMapThing(int id, QString name, QString description)
{
  ...
  set.clear();
  //event = EventSet::createBlankEvent(); // TODO: Remove
  event_base = true;
  x = 0;
  y = 0;
...
{
  base = NULL;
  //EventSet::deleteEvent(event); // TODO: Remove
  if(matrix != NULL)
    delete matrix;
  matrix = NULL;
}
 ...
 */
//Event EditorMapThing::getEvent() const // TODO: Remove
//{
//  if(isBaseEvent())
//    return base->event;
//  return event;
 ...
 * Output: none
 */
//void EditorMapThing::setEvent(Event event) // TODO: Remove
//{
